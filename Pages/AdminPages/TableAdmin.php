...
//SQL Menampilkan 
$data_akun = select("SELECT * FROM logininfo WHERE status='admin'");
...
<body>
  ...
  <div class="kontener" class="bg-transparent  position-absolute top-50 start-50 translate-middle shadow-lg"
    ...
    <!-- <button type="button" class="btn btn-outline-primary" style="border-radius:1em;" onclick="window.location.href='AdminPage.php'" >Back</button>  -->
    <br><br><br>
    <div class="container">
      <h1>DATA AKUN ADMIN</h1>
      <button type="button" class="btn btn-warning" style="border-radius:1em;"
        onclick="window.location.href='RegisAdmin.php?path=admin'">Register</button>
          ...
          <li class="table-row">
            ...
            <div class="col col-7" data-label="Action Button">
              ...
              <button type="button" class="btn btn-outline-warning " style="text-decoration:none;"
                onclick="window.location.href='../Actionpage/ubahakun.php?id=<?= $akuninfo['id']; ?>&role=admin&path=admin'">Ubah</button>
              <button type="button" class="btn btn-outline-danger" style="text-decoration:none;"
                onclick="window.location.href='../Actionpage/hapusakun.php?id=<?= $akuninfo['id']; ?>&role=admin&path=admin'"
