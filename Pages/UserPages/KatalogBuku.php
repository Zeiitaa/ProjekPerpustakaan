...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color: #FFECDB">
    <div class="container-fluid">
      ...
      <!-- Login Button -->
      <button type="button" class="Login btn btn-warning fs-5"
            ...
            <article class="card card--1">
              ...
              <div class="card__info">
                ...
                <div class="card__buttons">
                  <a href="../Buku/DetailBuku.php?id=<?= $bukuinfo['id']; ?>&path=SCat" class="btn-info">Info Buku</a>
                  <a href="Login.php" class="btn-warning">Pinjam</a>
                </div>
              </div>
            </article>
          <?php endforeach; ?>
